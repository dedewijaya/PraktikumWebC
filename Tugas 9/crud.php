	...
	if(isset($_POST['btnubah'])){
		...
		if(!empty($id) &&!empty($namalengkap) && !empty($namauser) && !empty($nim) && !empty($kelamin) && !empty($tempat) && !empty($tanggal) && !empty($asal) && !empty($jurusan) && !empty($pass)){
			...
			if($update && isset($_GET['aksi'])){
				if($_GET['aksi'] == 'update'){
					echo '<script language="javascript">alert("UPDATE BERHASIL");document.location="crud.php";</script>';
				}
				else{
...
function hapus($koneksi){
	...
	if(isset($_GET['id']) && isset($_GET['aksi'])){
		...
		if($hapus){
			if($_GET['aksi'] == 'delete'){
				echo '<script language="javascript">alert("DELETE BERHASIL");document.location="crud.php";</script>';
			}
			else{
